...
export class Address {
  ...
  @IsOptional()
  @IsString({ message: VALIDATION_ERRORS_MESSAGES.INVALID_STRING })
  @Length(0, 10, { message: VALIDATION_ERRORS_MESSAGES.lengthRange(1, 10) })
  ...
  @IsOptional()
  @IsString({ message: VALIDATION_ERRORS_MESSAGES.INVALID_STRING })
  @Length(0, 45, { message: VALIDATION_ERRORS_MESSAGES.lengthRange(1, 45) })
  @ApiProperty({
    example: "John Doe",
  ...
  @IsOptional()
  @IsString({ message: VALIDATION_ERRORS_MESSAGES.INVALID_STRING })
  @Length(0, 512, { message: VALIDATION_ERRORS_MESSAGES.lengthRange(1, 512) })
  @ApiProperty({
